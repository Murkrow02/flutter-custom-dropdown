...
class _SearchField<T> extends StatefulWidget {
  ...
  final int minSearchLength; // Added parameter
  ...
  const _SearchField.forListData({
    ...
    required this.minSearchLength, // Default to 1
    ...
    return Padding(
      ...
      child: TextField(
        ...
        onChanged: (val) async {
          ...
          if (val.length < widget.minSearchLength) {
            // Do nothing until the minimum length is met
            return;
          }
